...
def read_results(root: Path):
    path = root / "results" / "libero_spatial" / "openvla_7b_finetuned" / "seed_7" / "task_results.csv"
...
def make_official_comparison(root, out):
    summary_path = root / "results" / "libero_spatial" / "openvla_7b_finetuned" / "seed_7" / "overall_summary.json"
